  ...
  return (
    <section className="p-5 flex flex-col items-center">
      ...
      {faqs.map((faq, index) => (
        <div
          key={index}
          className=" flex flex-col lg:mb-12 gap-10  mb-5 lg:w-[700px] md:w-[500px] w-[300px] "
        >
          <div className="flex flex-col gap-2">
            <div className="flex flex-row bg-white rounded-full p-5 py-3 shadow-md shadow-[#779768]/40">
              <div className="w-[80%] md:w-[90%] flex justify-start items-center text-[#4D641E] font-semibold lg:text-lg text-md ">
                {faq.question}
              </div>
              <button
