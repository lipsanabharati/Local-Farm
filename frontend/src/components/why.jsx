...
{
    return (
        <section className="bg-[#F2F6E8] flex flex-col lg:gap-20  md:gap-20 gap-5 items-center lg:py-20 lg:px-20 md:py-10 md:px-10 w-screen max-w-[1440px] mx-auto md:h-auto  pt-10">
                {/*Heading*/}
