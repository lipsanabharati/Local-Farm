...
export default function Footer() {
  return (
    <footer className="text-white xl:-mt-30 -mt-30 md:-mt-20 w-screen">
      <svg
        // height="272"
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="md:flex hidden xl:hidden w-screen"
      >
        <path
      ...
      >
        <path
          d="M257.728 13.5988C246.119 8.49798 37.1264 -37.1731 0 73.8536V453H743V71.6704C695.096 33.8778 575.56 14.641 467.718 41.8334C359.876 69.0259 269.337 18.6996 257.728 13.5988Z"
          fill="#344304"
        />
      </svg>
