...
export default function Footer() {
  return (
    <footer className="text-white xl:-mt-5 -mt-30 md:-mt-20 lg:-mt-5 w-screen">
      ...
      <svg width="743" height="461" viewBox="0 0 743 461" fill="none" xmlns="http://www.w3.org/2000/svg"
      className="md:hidden flex max-w-screen">
          <path d="M257.728 20.8919C205.456 -2.07376 37.1264 -29.88 0 81.1467V460.293H743V78.9635C695.096 41.171 570.936 38.4611 467.718 49.1265C364.5 59.792 310 43.8575 257.728 20.8919Z" fill="#344304"/>
          </svg>


      <div className="p-5 lg:p-10 md:-mt-30 -mt-70 md:top-20 left-0 flex flex-col items-start md:items-center justify-center text-white font-body bg-[#344304] w-full gap-5">
