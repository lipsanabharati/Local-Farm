  ...
  return (
    <motion.section className="lg:h-screen h-150 h-100  min-w-screen max-w-[1440px]  pb-10 flex flex-col">
      <motion.div
        ...
        className="h-full w-full bg-[url('/https://res.cloudinary.com/dpff5cxm3/image/upload/v1787108200/maps_ld2hmf.svg/maps.svg')] bg-contain bg-top bg-no-repeat inset-0"
        animate={{ y: [0, -10, 0] }}
        transition={{
          duration: 4,
          repeat: Infinity,
