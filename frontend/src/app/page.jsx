...
export default function Home() {
  ...
  return (
    <div className="w-screen overflow-hidden flex flex-col items-center">
      ...
      {/*Product Section*/}
      <section className="flex flex-col py-10 px-10 lg:gap-10 gap-5 font-body items-center bg-[#F2F6E8] w-screen max-w-[1440px] ">
        <h1 className="font-heading lg:text-[56px] md:text-[36px] text-xl font-bold text-start text-[#4D641E] md:text-center w-full">
